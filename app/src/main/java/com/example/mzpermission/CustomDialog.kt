...
import com.example.mzpermission.databinding.CustomDialogLayoutBinding
import com.example.mzpermission.databinding.PermissionsItemBinding
    ...
    private fun buildPermissionsLayout() {
        for (permission in permissions) {
            ...
            if (permissionGroup != null && !groupSet.contains(permissionGroup)) {
                val itemBinding = PermissionsItemBinding
                    .inflate(layoutInflater, binding.permissionsLayout, false)
                itemBinding.root.text = context.packageManager
                    .getPermissionGroupInfo(permissionGroup, 0).loadLabel(context.packageManager)
