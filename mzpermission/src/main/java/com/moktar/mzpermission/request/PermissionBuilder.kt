...
import com.moktar.mzpermission.callback.ExplainReasonCallback
import com.moktar.mzpermission.callback.ExplainReasonCallbackWithBeforeParam
import com.moktar.mzpermission.callback.ForwardToSettingsCallback
import com.moktar.mzpermission.callback.RequestCallback
import com.moktar.mzpermission.dialog.RationaleDialog
import com.moktar.mzpermission.request.*

import com.moktar.mzpermission.dialog.DefaultDialog
import com.moktar.mzpermission.dialog.RationaleDialogFragment
import java.util.*

/**
 * More APIs for developers to control MzPermission functions.
 *
 * @author moktar
 * @since 2022/08/10
 */
class PermissionBuilder(
    ...
    /**
     * Indicates should MzPermission explain request reason before request.
     */
    @JvmField
     ...
     * If not called, requestCallback will be called by MzPermission automatically.
     */
    @JvmField
    ...
    fun showHandlePermissionDialog(
        ...
        dialogFragment.showNow(fragmentManager, "MzPermissionRationaleDialogFragment")
